...
// Warna-warna ini diambil dari colors.xml dan disesuaikan untuk skema warna Compose Material 3.
// Anda bisa menggunakan generator tema Material (https://m3.material.io/theme-builder)
// untuk menghasilkan skema warna ini berdasarkan warna primer Anda.
...
val md_theme_light_surfaceTint = Color(0xFF0061A4) // Biasanya sama dengan primary
...
val md_theme_dark_surfaceTint = Color(0xFF9FCAFF) // Biasanya sama dengan primary (dark)
